...
|  15  | Logic Programming<br>([introduction]())<br>([rules and queries]())<br>([arithmetic and lists]())<br>([slides](slides/logic-languages.pdf)) | Chapter 16 | **Friday, December 11** Term Paper |
